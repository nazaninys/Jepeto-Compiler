...
public interface JepetoVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JepetoParser#functionBody}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionBody(JepetoParser.FunctionBodyContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JepetoParser#singleArgument}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSingleArgument(JepetoParser.SingleArgumentContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JepetoParser#singleArgumentWithKey}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSingleArgumentWithKey(JepetoParser.SingleArgumentWithKeyContext ctx);
	/**
