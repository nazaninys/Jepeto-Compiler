...
public interface JepetoListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JepetoParser#functionBody}.
	 * @param ctx the parse tree
	 */
	void enterFunctionBody(JepetoParser.FunctionBodyContext ctx);
	/**
	 * Exit a parse tree produced by {@link JepetoParser#functionBody}.
	 * @param ctx the parse tree
	 */
	void exitFunctionBody(JepetoParser.FunctionBodyContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JepetoParser#singleArgument}.
	 * @param ctx the parse tree
	 */
	void enterSingleArgument(JepetoParser.SingleArgumentContext ctx);
	/**
	 * Exit a parse tree produced by {@link JepetoParser#singleArgument}.
	 * @param ctx the parse tree
	 */
	void exitSingleArgument(JepetoParser.SingleArgumentContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JepetoParser#singleArgumentWithKey}.
	 * @param ctx the parse tree
	 */
	void enterSingleArgumentWithKey(JepetoParser.SingleArgumentWithKeyContext ctx);
	/**
	 * Exit a parse tree produced by {@link JepetoParser#singleArgumentWithKey}.
	 * @param ctx the parse tree
	 */
	void exitSingleArgumentWithKey(JepetoParser.SingleArgumentWithKeyContext ctx);
	/**
